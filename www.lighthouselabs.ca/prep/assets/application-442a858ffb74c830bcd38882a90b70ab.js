...
ga('create', 'UA-30299155-2', 'lighthouselabs.ca');
...
$(document).ready(function() {
  ...
  //SET UUID
  var uuid = getUrlParameterValue('uuid') || randomUUID();
  $('#contact-form #uuid').val(uuid);
...
*/
	...
	$('a[href*=#]:not([href=#])').click(function() {
	    if($(this).parent().parent().hasClass("nav-pills")){
	    	return false;
	    }
	           ...
	           if (target.length) {
	           	if ($(".navbar").css("position") == "fixed" ) {
	           		...
	           		if ( ($("#book-body").length > 0) ){
	           			pad = 120;//120; //this is for the book pages
	           		}
	             	$('html,body').animate({
	...
	//make square picture
	var teamWidth = $(".team-member").width();
	$(".team-member").css({'height':teamWidth+'px'});
	$(".team-member-details").css({'height':teamWidth+'px'});
	//rising text
	var lineHeight = $(".team-member-details div:first-child").outerHeight();
	$(".team-member-details").css({'top':(teamWidth - lineHeight)+'px'})
   ...
   /* $("#contact-form").submit(function() {
	...
	// This is to switch out availability dates if iOS or Web is clicked
	$("#Field20").change(function(){
	  $("#Field14").empty();
	  if($("#Field20").val()=="iOS Development"){
	    var x = ["July", "September"];
	  }
	  else{
	    var x = ["January","February","March","April","May","June","July","August","September","October","November","December"];
	  }
	  $.each(x, function(key,value){
	    $("#Field14").append("<option value='" + value + "'>" + value + "</option>");
	  });
	});

	// ==================== TWITTER FEED ==================== //
	// THIS NO LONGER WORKS DUE TO DEPRECATION OF TWITTER API 1.0 FOR 1.1 - KV
	/*$("#tweets-feed").tweet({
	  join_text: false,
	  username: "lighthouse_labs", // Change username here
	  modpath: 'js/jquery.tweet.js',
	  avatar_size: false,
  ...
  $(document).ready(function() {
    if(getUrlParameterValue('uuid')){
      $('.hide-when-id-present').hide();
      $('.hide-when-id-present input').removeAttr('required');
    }
  });
